...
public class Plugin : BasePlugin
{
    ...
    // ///
    // /// .rewritecode-example "some quoted string" 1 1.5
    // /// .rewritecode-example boop 21232
    // /// .rewritecode-example boop-boop
    // ///</remarks>
    // [Command("rewritecode-example", description: "Example command from rewritecode", adminOnly: true)]
